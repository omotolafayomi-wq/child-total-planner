...
const PILLAR = "CHILD_DEVELOPMENT_TRACKER";
const MODULE_DESCRIPTION = "Track overall development milestones and progress across all areas.";
const GUIDANCE = [
  "Use this tracker to see the big picture of your child&apos;s development.",
  "Update regularly to see patterns and growth over time.",
  "Focus on progress, not comparison with others.",
  "Share observations with co-parents or caregivers.",
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Development Tracker</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Milestone checklists, progress charts, and development summaries will be added.
        </p>
      </div>
    </div>
  );
