...
const PILLAR = "SCHOOL_TERM_DEVELOPMENT";
const MODULE_DESCRIPTION = "Structure school term time for balanced academic and holistic development.";
const GUIDANCE = [
  "Map out key dates: exams, holidays, school events at the start of term.",
  "Balance academic goals with development across all pillars.",
  "Plan weekly routines that include study, activities, and rest.",
  "Review progress weekly and adjust plans as needed.",
  "Communicate with teachers to align home and school support.",
];

export default function SchoolTermPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">School Term Development</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Term planners, exam prep schedules, and school activity trackers will be added.
        </p>
      </div>
    </div>
  );
