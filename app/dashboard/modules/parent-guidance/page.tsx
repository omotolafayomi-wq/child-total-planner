...
const MODULE_DESCRIPTION = "Resources, strategies, and support for parents guiding child development.";
const GUIDANCE = [
  "Your role is guide, not director — follow your child&apos;s lead when possible.",
  "Create an environment where mistakes are safe and learning is celebrated.",
  "Consistency matters more than perfection in parenting approaches.",
  "Take care of your own wellbeing — you cannot pour from an empty cup.",
  "Connect with other parents for support and shared learning.",
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Parent Guidance</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Parent coaching videos, discussion guides, and age-specific strategies will be added.
        </p>
      </div>
    </div>
  );
