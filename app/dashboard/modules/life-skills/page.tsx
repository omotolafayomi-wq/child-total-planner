...
const PILLAR = "LIFE_SKILLS";
const MODULE_DESCRIPTION = "Develop practical life skills for independence and daily living.";
const GUIDANCE = [
  "Start with basic self-care tasks and progress to household responsibilities.",
  "Involve children in real family tasks — they learn by doing.",
  "Celebrate effort over perfection when learning new skills.",
  "Create checklists for routines: morning, evening, weekly tasks.",
    ...
    <div className="space-y-6">
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> More activities, skill trackers, and independence milestones will be added to this module.
        </p>
      </div>
    </div>
  );
