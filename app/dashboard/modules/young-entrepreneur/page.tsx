...
const PILLAR = "YOUNG_ENTREPRENEUR";
const MODULE_DESCRIPTION = "Develop entrepreneurial thinking, financial literacy, and business awareness.";
const GUIDANCE = [
  "Start with small, low-risk ventures like selling crafts or helping neighbours.",
  "Discuss the value of money, saving, and giving as core principles.",
  "Help identify problems in the community that could become business ideas.",
  "Emphasise learning from failure — not every venture succeeds.",
  "Connect with local entrepreneurs for real-world learning.",
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Young Entrepreneur</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Business plan templates, market research activities, and enterprise challenges will be added.
        </p>
      </div>
    </div>
  );
