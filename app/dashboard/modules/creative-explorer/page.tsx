...
const PILLAR = "CREATIVE_EXPLORER";
const MODULE_DESCRIPTION = "Explore creativity through arts, storytelling, music, and imaginative expression.";
const GUIDANCE = [
  "Provide materials and space for creative expression without judgment.",
  "Encourage process over product — the act of creating matters most.",
  "Explore diverse art forms: drawing, writing, drama, music, crafts.",
  "Display and celebrate creative work at home.",
  "Visit galleries, performances, or cultural events when possible.",
];

export default function CreativeExplorerPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Creative Explorer</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Creative portfolios, project showcases, and arts challenges will be added.
        </p>
      </div>
    </div>
  );
