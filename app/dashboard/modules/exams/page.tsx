...
const PILLAR = "EXAM_PREPARATION";
const MODULE_DESCRIPTION = "Develop effective study habits and exam preparation skills.";
const GUIDANCE = [
  "Create a consistent study routine with breaks built in.",
  "Practice past questions under timed conditions to build confidence.",
  "Focus on understanding concepts, not just memorisation.",
  "Address test anxiety through preparation and relaxation techniques.",
  "Celebrate improvement and effort, not just final scores.",
];
    ...
    <div className="space-y-6">
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Study schedule builders, past question trackers, and revision planners will be added.
        </p>
      </div>
    </div>
  );
