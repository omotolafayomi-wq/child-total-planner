...
const PILLAR = "CHARACTER_VALUES";
const MODULE_DESCRIPTION = "Develop character strengths, values, and moral reasoning.";
const GUIDANCE = [
  "Model the values you want to see — children learn more from what you do than what you say.",
  "Use stories, proverbs, and real-life situations to discuss values.",
  "Encourage reflection on choices and consequences.",
  "Celebrate acts of kindness, honesty, and courage.",
  "Create family values that guide daily decisions.",
];

export default function CharacterValuesPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Character & Values</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Character journals, value-based challenges, and reflection prompts will be added.
        </p>
      </div>
    </div>
  );
