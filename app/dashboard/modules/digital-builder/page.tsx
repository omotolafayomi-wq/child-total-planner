...
const PILLAR = "DIGITAL_BUILDER";
const MODULE_DESCRIPTION = "Build digital literacy, online safety awareness, and responsible technology use.";
const GUIDANCE = [
  "Start with online safety fundamentals before exploring creative tools.",
  "Set clear boundaries for screen time and digital activities together.",
  "Explore free tools: Google workspace, Canva, Scratch, and educational apps.",
  "Discuss digital footprints and the permanence of online actions.",
  "Balance digital activities with offline development.",
];

export default function DigitalBuilderPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Digital Builder</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> More activities, project ideas, and digital skill trackers will be added to this module.
        </p>
      </div>
    </div>
  );
