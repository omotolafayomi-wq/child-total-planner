...
const PILLAR = "FUTURE_READY";
const MODULE_DESCRIPTION = "Prepare for future careers, higher education, and lifelong learning.";
const GUIDANCE = [
  "Explore diverse career paths through conversations and real-world exposure.",
  "Connect school subjects to real-world applications and careers.",
  "Develop transferable skills: communication, problem-solving, collaboration.",
  "Introduce the concept of lifelong learning and adaptability.",
  "Encourage curiosity about how things work and why.",
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Future Ready</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Career exploration tools, skill mapping, and future planning templates will be added.
        </p>
      </div>
    </div>
  );
