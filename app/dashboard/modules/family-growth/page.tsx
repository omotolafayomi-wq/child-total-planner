...
const PILLAR = "FAMILY_GROWTH";
const MODULE_DESCRIPTION = "Strengthen family bonds, traditions, and shared growth experiences.";
const GUIDANCE = [
  "Create regular family rituals: meals together, storytelling nights, shared projects.",
  "Document family history and stories for future generations.",
  "Involve children in family decision-making age-appropriately.",
  "Balance individual development with family togetherness.",
  "Celebrate each family member&apos;s unique contributions.",
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Family Growth</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Family tradition trackers, shared goal-setting, and family meeting templates will be added.
        </p>
      </div>
    </div>
  );
