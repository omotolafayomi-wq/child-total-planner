...
const PILLAR = "HOLIDAY_GROWTH";
const MODULE_DESCRIPTION = "Maximise holiday periods for growth, exploration, and family connection.";
const GUIDANCE = [
  "Plan a mix of structured activities and free time during holidays.",
  "Use holidays for deeper projects that are hard to fit in term time.",
  "Include rest and recovery — downtime is important too.",
  "Involve children in planning their holiday activities.",
  "Balance learning, play, service, and family time.",
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Holiday Growth</h1>
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Holiday planners, project ideas, and break-time challenges will be added.
        </p>
      </div>
    </div>
  );
