...
const PILLAR = "HEALTH_WELLBEING";
const MODULE_DESCRIPTION = "Support physical health, mental wellbeing, and healthy lifestyle habits.";
const GUIDANCE = [
  "Establish regular routines for sleep, meals, and physical activity.",
  "Talk openly about emotions and provide safe space for expression.",
  "Model healthy habits — children learn by watching.",
  "Limit screen time and encourage outdoor play and social interaction.",
  "Address body image, self-esteem, and peer relationships age-appropriately.",
];
    ...
    <div className="space-y-6">
      ...
      <div className="card bg-muted/50">
        <p className="text-sm text-muted-foreground">
          <span className="font-medium">Coming soon:</span> Wellness trackers, exercise challenges, and mental health resources will be added.
        </p>
      </div>
    </div>
  );
