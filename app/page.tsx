...
function FamilyIllustration() {
  return (
    <svg viewBox="0 0 400 300" className="w-full max-w-md mx-auto mb-8" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect x="50" y="180" width="300" height="80" rx="8" fill="#F1F5F9" stroke="#DCE4EC" strokeWidth="2"/>
      <rect x="80" y="140" width="60" height="60" rx="8" fill="#E7F5ED" stroke="#3FA36B" strokeWidth="2"/>
      <rect x="170" y="120" width="60" height="80" rx="8" fill="#FFF5D8" stroke="#F4B942" strokeWidth="2"/>
      <rect x="260" y="150" width="60" height="50" rx="8" fill="#E0F2FE" stroke="#2B82BD" strokeWidth="2"/>
      <circle cx="110" cy="120" r="20" fill="#F1F5F9" stroke="#3FA36B" strokeWidth="2"/>
      <path d="M100 120 L110 110 L120 120 L110 130 Z" fill="#3FA36B"/>
      <circle cx="200" cy="100" r="24" fill="#F1F5F9" stroke="#F4B942" strokeWidth="2"/>
      <path d="M188 100 L200 88 L212 100 L200 112 Z" fill="#F4B942"/>
      <circle cx="290" cy="130" r="20" fill="#F1F5F9" stroke="#2B82BD" strokeWidth="2"/>
      <path d="M280 130 L290 120 L300 130 L290 140 Z" fill="#2B82BD"/>
      <rect x="150" y="200" width="100" height="40" rx="4" fill="white" stroke="#DCE4EC" strokeWidth="1.5"/>
      <line x1="170" y1="215" x2="230" y2="215" stroke="#DCE4EC" strokeWidth="2"/>
      <line x1="170" y1="225" x2="210" y2="225" stroke="#DCE4EC" strokeWidth="2"/>
    </svg>
  );
}
...
export default function Home() {
  ...
  const pillarHref = (slug: string) => {
    if (session) {
      return `/${slug}`;
    }
    return `/login?redirect=/${slug}`;
  };
      ...
      <main className="flex-1 w-full">
          ...
          <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 lg:py-32 relative">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href={session ? "/dashboard/children" : "/signup"} className="btn-accent text-base px-8 py-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {pillars.map((pillar) => (
                <Link
                  ...
                  className={`card-interactive rounded-xl border ${pillar.color} p-6 text-center focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent`}
        ...
        <section className="border-t border-border bg-white">
          <div className="max-w-6xl mx-auto px-4 py-16 md:py-24 text-center">
            ...
            <Link href={session ? "/dashboard/children" : "/signup"} className="btn-primary text-base px-8 py-3">
