...
const sections = [
  ...
  { id: "email", title: "Email", content: "Email addresses are used for account verification, security alerts and optional product updates. You may unsubscribe from non-essential emails at any time using the link in the message." },
